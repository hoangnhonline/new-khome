...
<head>
  ...
  <title>KHMERBETA | <?php echo e(trans('text.dashboard')); ?></title>
  ...
  <link rel="stylesheet" href="<?php echo e(URL::asset('public/admin/plugins/colorpicker/bootstrap-colorpicker.min.css')); ?>">
...
<input type="hidden" id="upload_url" value="<?php echo e(config('kkaffee.upload_url')); ?>">
